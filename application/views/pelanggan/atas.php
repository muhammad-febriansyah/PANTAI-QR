  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      <a href="pelanggan/" class="logo d-flex align-items-center">
        ...
        <span> Panrita Lopi</span>
      </a>
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto " href="pelanggan/index">Beranda</a></li>
          <li><a class="nav-link scrollto" href="pelanggan/tiket">Pesan Tiket</a></li>
          <li><a class="nav-link scrollto" href="pelanggan/pesanansaya">Pesanan Saya</a></li>
          <li><a class="nav-link scrollto" href="pelanggan/logout">Logout</a></li>
